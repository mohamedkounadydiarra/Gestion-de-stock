<?php require("../controller/AjouterCategorie.php"); ?>
...
<body id="page-top">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="col-lg-6">
      ...
      <script>    
 	    setTimeout(function(){
      window.location = "ListeCategorie.php";}, 2000);
      </script>
      <?php } ?>
        ...
        <div class="card-body">
          <form method="POST">
            <div class="form-group">
              ...
              <input type="text" name="nom" class="form-control" id="" aria-describedby=""
                placeholder="entrer le nom du produit">
            </div>

            <input type="submit" name="enregistrer" class="btn btn-primary" value="Enregister">
          </form>
        </div>
      </div>
    </div>
