<?php 
require("../controller/EditerProduit.php"); 
...
<body id="page-top">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="col-lg-6">
      ...
      <?php
      $encian = editer($idProduit); 
      foreach($encian as $encians){ 
       ?>
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form method="POST">
            <div class="form-group">
              ...
              <input type="text" name="designation" class="form-control" id="" aria-describedby=""
                placeholder="entrer le nom du produit" value="<?= $encians['designation']; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Quantité</label>
              <input type="numbre" name="quantite" class="form-control" value="<?= $encians['quantite']; ?>" id="" placeholder="enter la quantité du produit">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Quantité minimale</label>
              <input type="numbre" name="stockMin" class="form-control" value="<?= $encians['stockMin']; ?>" id="exampleInputPassword1" placeholder="la quantite min" >
            </div>
            <?php 
            ...
            <button type="submit" name="update" class="btn btn-primary">Mise à jour</button>
          </form>
        </div>
      </div>
    </div>
