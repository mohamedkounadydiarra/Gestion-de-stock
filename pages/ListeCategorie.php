<?php require("../modele/AjouterCategorie.php"); ?>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="../controller/deleteCategorie.php?idCategorie=<?= $listes['idCategorie']; ?>"><input type="submit" class="btn btn-danger" value="supprimer"></a></td>
                        <td><a href="editerCategorie.php?idCategorie=<?= $listes['idCategorie']; ?>"><input type="submit" class="btn btn-primary" value="Editer"></a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
