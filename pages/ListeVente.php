              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                    <?php $liste = listeVente(); foreach($liste as $listes){ ?>
                      <tr>
                        <td><?php echo $listes['designation']; ?></td>
                        <td><?php echo $listes['quantite']; ?></td>
                        <td><?php echo $listes['types']; ?></td>
                        <td><?php echo $listes['dateSortie']; ?></td>
                        <td><a href="DetailVente.php?idSortie=<?= $listes['idSortie'];?>"><input type="submit" class="btn btn-danger" value="Detail"></a></td>
